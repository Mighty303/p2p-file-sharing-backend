...
// path: '/' means the internal PeerJS path (will become /peerjs/peerjs when mounted at /peerjs)
...
// Mount PeerJS at /peerjs - this makes WebSocket available at /peerjs/peerjs
